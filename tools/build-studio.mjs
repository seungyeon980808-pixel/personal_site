...
const css=(await Promise.all(['style.css','entrance.css','desktop.css','workspace.css','phone.css','solid-phone.css','community.css','calendar.css','about.css'].map(name=>fs.readFile(new URL(`src/studio/${name}`,root),'utf8')))).join('\n');
